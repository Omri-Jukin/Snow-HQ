...
const ResponsiveBackground: React.FC<ResponsiveBackgroundProps> = React.memo(({ children }) => {
  const { scrollProgress } = useScrollPosition()

  return <BackgroundContainer scrollProgress={scrollProgress}>{children}</BackgroundContainer>
})
