...
// Avoid next-intl for now to keep SSR simple; use 'en' as current locale placeholder
const useLocale = () => 'en' as const
// TODO: wire locales source; temporary static list to avoid bad alias
const locales = ['en', 'es', 'fr', 'he'] as const
...
export default function LanguageSwitcher() {
  ...
  if (!isClient) {
    return (
      <StyledLanguageBox>
        <StyledLanguageButton size="small" startIcon={<LanguageIcon />} disabled>
