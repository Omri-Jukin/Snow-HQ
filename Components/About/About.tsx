...
import { RainbowButton } from '../Button/Button.style'
...
const About: React.FC<AboutProps> = ({ onSkillClick }) => {
  ...
  return (
    <AboutContainer aria-labelledby="about-title" id={ABOUT_CONSTANTS.SECTION_ID}>
      <MotionWrapper variant="fadeIn" duration={ABOUT_CONSTANTS.ANIMATION.TITLE_DURATION}>
        ...
        <SkillsContainer>
          <SkillsTagsContainer>
            <SkillTag
              ...
              onClick={() => onSkillClick?.(ABOUT_CONSTANTS.SKILLS.CODE_CONJURER)}
              variant="outlined"
            />
            <SkillTag
              label={t('skills.brandArchitect')}
              onClick={() => onSkillClick?.(ABOUT_CONSTANTS.SKILLS.BRAND_ARCHITECT)}
              variant="outlined"
            />
            <SkillTag
              label={t('skills.designDreamer')}
              onClick={() => onSkillClick?.(ABOUT_CONSTANTS.SKILLS.DESIGN_DREAMER)}
              variant="outlined"
            />
          </SkillsTagsContainer>
        </SkillsContainer>
      ...
      <MotionWrapper
        ...
        delay={ABOUT_CONSTANTS.ANIMATION.DESCRIPTION_DELAY}
      >
        <RainbowButton onClick={() => router.push('/resume')}>
