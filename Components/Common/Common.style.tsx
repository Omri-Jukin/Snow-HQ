...
export const HeroTitle = styled(Typography)(({ theme }) => ({
  fontWeight: 700,
  background: `radial-gradient(circle at 50% 50%, ${theme.palette.primary.main} 0%, ${theme.palette.secondary.main} 40%, ${theme.palette.text.primary} 80%, ${theme.palette.primary.light} 100%)`,
  backgroundClip: 'text',
